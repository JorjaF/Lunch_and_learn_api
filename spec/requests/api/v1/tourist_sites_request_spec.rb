  ...
  describe 'GET /api/v1/tourist_sites' do
    context 'when providing a valid country for Happy Path' do
      ...
      before do
        ...
        # Stubbing Places API for tourist sites
    ...
    #   let(:sad_path_country) { 'Ecuador' }

    #   before do
    #     # Stubbing RESTful Countries API for invalid country
    #     stub_request(:get, "https://restcountries.com/v3.1/name/#{sad_path_country}")
    #       .to_return(
    #         status: 404,
    #         body: '',
    #         headers: {}
    ...
    #     expect(json_response['error']).to eq('Country not found')
    #   end
    # end
  end
end
